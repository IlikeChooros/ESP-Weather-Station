...
{
    // first line
    _tft->fillCircle(x + 0.5f * size, y + 0.5f * size, 0.5f * size, WIFI_BG);
    ...
    // second line
    _tft->fillCircle(x + 0.5f * size, y + 0.55f * size, 0.3f * size, WIFI_BG);
    ...
    // center circle
    _tft->fillCircle(x + 0.5f * size, y + 0.65 * size, 0.1f * size, WIFI_BG);
}